...
import { TrendingUp, TrendingDown, Star, Clock, Users, Utensils } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-5 bg-white dark:bg-slate-900">
        <h3 className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-4">7-Day Revenue Trend</h3>
